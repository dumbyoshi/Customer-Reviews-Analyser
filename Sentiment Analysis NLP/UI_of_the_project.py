...
def load_model():
    ...
    where do we type mam..what?? to check our own review as + or /// and also to show the pie chart and word clod
    scrappedReviews = pd.read_csv(r'C:\Users\nithi\OneDrive\Documents\Sentiment Analysis NLP\scrappedReviews.csv')
